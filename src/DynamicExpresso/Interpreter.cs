...
namespace DynamicExpresso
{
	...
	public class Interpreter
	{
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public Interpreter SetVariable([NotNull] string name, object value)
		{
		...
		/// <returns></returns>
		public Interpreter SetVariable([NotNull] string name, object value, [NotNull] Type type)
		{
		...
		/// <returns></returns>
		public Interpreter SetExpression([NotNull] string name, [NotNull] Expression expression)
        {
            if (string.IsNullOrWhiteSpace(name)) throw new ArgumentNullException(nameof(name));
		...
		/// <returns></returns>
		public Interpreter SetIdentifiers([NotNull] IEnumerable<Identifier> identifiers)
		{
		...
		/// <returns></returns>
		public Interpreter SetIdentifier([NotNull] Identifier identifier)
		{
			if (identifier == null) throw new ArgumentNullException(nameof(identifier));
			if (LanguageConstants.ReservedKeywords.Contains(identifier.Name)) throw new InvalidOperationException($"{identifier.Name} is a reserved word");
		...
		/// <param name="type"></param>
		/// <returns></returns>
		public Interpreter Reference([NotNull] Type type)
		{
			if (type == null) throw new ArgumentNullException(nameof(type));
		...
		/// <returns></returns>
		public Interpreter Reference([NotNull] IEnumerable<ReferenceType> types)
		{
		...
		/// <returns></returns>
		public Interpreter Reference([NotNull] Type type, [NotNull] string typeName)
        {
		...
		/// <param name="type"></param>
		/// <returns></returns>
		public Interpreter Reference([NotNull] ReferenceType type)
		{
			if (type == null) throw new ArgumentNullException(nameof(type));
